...
export function clamp(v, min, max) {
    try {
        ...
        throw TypeError(`function requires numeric arguments, got v=${v}, min=${min}, max=${max}`);
    }
...
export function remap(v, in_min, in_max, out_min, out_max, steps = 0, edges = 'none') {
    ...
    try {
        ...
        throw TypeError(`function requires numeric arguments, got v=${v}, in_min=${in_min}, in_max=${in_max}, out_min=${out_min}, out_max=${out_max}`);
    }
    switch (edges) {
        case 'clamp':
...
export function bitwise_not(value) {
    return ~value;
}
...
export function multiply(value, arg) {
    return Number(value) * Number(arg);
}
export function add(value, arg) {
    return Number(value) + Number(arg);
}

...
export declare function bitwise_and(value_one: number, value_two: number): number;
export declare function bitwise_or(value_one: number, value_two: number): number;
export declare function bitwise_xor(value_one: number, value_two: number): number;
export declare function bitwise_not(value: number): number;

...
export declare function time_since(datetime: PyDatetime, precision?: number): string | PyDatetime | null;
export declare function time_until(datetime: PyDatetime, precision?: number): string | PyDatetime | null;

...
export function number_translated(
	hass: HomeAssistant,
	value: number,
	precision?: number,
) {
...
export function date_translated(
	hass: HomeAssistant,
	value: date | datetime | Date | string,
) {
...
function resolveTimeZone(hass: HomeAssistant) {
...
export function getTimeFormatter(hass: HomeAssistant) {
...
export function time_translated(value: time | datetime | Date | string) {
	try {
		let time: Date;
		if (typeof value === 'string') {
...
export function datetime_translated(
	hass: HomeAssistant,
